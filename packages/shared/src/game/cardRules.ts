// Shared card rules — single source of truth for both client and server.
// Covers rank comparison, play validation, burn detection, and hand sorting.
