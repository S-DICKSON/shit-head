  ...
  <div class="min-h-screen flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
      ...
      <div class="text-center mb-8">
        <h1 class="text-4xl font-bold text-gray-800 mb-2">Shithead Online</h1>
        <p class="text-gray-500 text-sm">Play the classic card game with friends</p>
      </div>

      <!-- Connection status -->
      <div v-if="isConnecting" class="mb-6 p-3 bg-yellow-50 border border-yellow-200 rounded-lg text-yellow-800 text-sm text-center">
        Connecting to server...
      </div>
      <div v-else-if="!isConnected" class="mb-6 p-3 bg-red-50 border border-red-200 rounded-lg text-red-800 text-sm text-center">
      ...
      <div class="mb-6">
        ...
        />
        <p class="text-xs text-gray-500 mt-1">Enter the 6-character room code</p>
      </div>
      ...
      <!-- Error message -->
      <div v-if="errorMessage" class="mt-6 p-3 bg-red-50 border border-red-200 rounded-lg text-red-800 text-sm">
        {{ errorMessage }}
      </div>
    </div>
  </div>
